...
public class FieldPanl extends PanlBaseField {
	private static final Logger LOGGER = LoggerFactory.getLogger(FieldPanl.class);

	public FieldPanl(String panlFacetProperty, Properties properties, String collectionName, int panlLpseNum) throws PanlServerException {
