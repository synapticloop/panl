...
public class PanlPassThroughField extends PanlBaseField {
	private static final Logger LOGGER = LoggerFactory.getLogger(PanlPassThroughField.class);

	public PanlPassThroughField(String panlFacetProperty, Properties properties, String collectionName) throws PanlServerException {
